...
INSERT INTO public.properties VALUES (1000, 1, 10, 100, 2);
...
--
-- Name: elements symble_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symble_unique UNIQUE (symbol);
